...
void MD5Final(u8* decrypt,u8* encrypt, u16 length)
{
    ...
    MD5_CTX* pmd5 = &md5;
    MD5Init(pmd5);
    MD5Update(pmd5,encrypt,length);
    index = (pmd5->count[0] >> 3) & 0x3F;
    padlen = (index < 56)?(56-index):(120-index);
    MD5Encode(bits,pmd5->count,8);
    MD5Update(pmd5,PADDING,padlen);
    MD5Update(pmd5,bits,8);
    MD5Encode(decrypt,pmd5->state,16);
}
